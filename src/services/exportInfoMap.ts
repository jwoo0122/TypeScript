...
namespace ts {
    ...
    export function createCacheableExportInfoMap(
        ...
        const symbols = new Map<
            number,
            [symbol: Symbol, moduleSymbol: Symbol]
        >();
        /**
        ...
        const cache: ExportInfoMap = {
            isUsableByFile: (importingFile) =>
                importingFile === usableByFileName,
            ...
            add: (
                ...
                const namedSymbol =
                    (isDefault && getLocalSymbolForExportDefault(symbol)) ||
                    symbol;
    ...
    function isImportablePathNode(
        ...
        const toNodeModulesParent =
            toNodeModules &&
            getDirectoryPath(getCanonicalFileName(toNodeModules));
        return (
            ...
            if (
                ...
                !(
                    ...
                    ambient.declarations?.every((d) =>
                        isExcluded(d.getSourceFile().fileName)
                    )
                )
            ) {
    ...
    export function getDefaultLikeExportInfo(
        ...
        const info = getDefaultExportInfoWorker(
            symbol,
            checker,
            compilerOptions
        );
    ...
    function getDefaultLikeExportWorker(
        ...
        | { readonly symbol: Symbol; readonly exportKind: ExportKind }
        | undefined {
    ...
    function getDefaultExportInfoWorker(
        ...
        | { readonly symbolForMeaning: Symbol; readonly name: string }
        | undefined {
